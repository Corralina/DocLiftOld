...
public interface ResolutionRepo extends JpaRepository<Resolution, Long>{
    ...
    Iterable<Resolution> findAllByStatusFinishFalseAndDocumentNumberLikeAndAgreesInformationIndividualInitialsLikeAndFillingInformationIndividualInitialsLike(String number, String agrees, String filling, Sort sort);
    Iterable<Resolution> findAllByStatusFinishFalseAndDocumentNumberLikeAndAgreesInformationIndividualInitialsLikeAndFillingInformationIndividualInitialsLikeAndDateAfterAndDateBefore(String number, String agrees, String filling, LocalDate start, LocalDate stop, Sort sort);
    Iterable<Resolution> findAllByStatusFinishFalseAndDocumentNumberLikeAndAgreesInformationIndividualInitialsLikeAndFillingInformationIndividualInitialsLikeAndDate(String number, String agrees, String filling, LocalDate date, Sort sort);

    Iterable<Resolution> findAllByStatusFinishTrueAndDocumentNumberLikeAndAgreesInformationIndividualInitialsLikeAndFillingInformationIndividualInitialsLike(String number, String agrees, String filling, Sort sort);
    Iterable<Resolution> findAllByStatusFinishTrueAndDocumentNumberLikeAndAgreesInformationIndividualInitialsLikeAndFillingInformationIndividualInitialsLikeAndDateAfterAndDateBefore(String number, String agrees, String filling, LocalDate start, LocalDate stop, Sort sort);
    Iterable<Resolution> findAllByStatusFinishTrueAndDocumentNumberLikeAndAgreesInformationIndividualInitialsLikeAndFillingInformationIndividualInitialsLikeAndDate(String number, String agrees, String filling, LocalDate date, Sort sort);
