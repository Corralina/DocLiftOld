 ...
 */
package com.company.ellRes.fileService.converterHTMLDOCX.simple;

import com.company.ellRes.fileService.converterHTMLDOCX.main.XHTMLImporterImpl;
...
public class ConvertInXHTMLDocument {
    ...
    public void maini() throws Exception {
        ...
        String inputfilepath = "C:\\\\DocumentLift\\act\\fileHtml\\source.html";
		...
		wordMLPackage.save(new File("C:\\DocumentLift\\act\\fileHtml\\storage.docx") );
