...
<@dom.dom>
    ...
    <form action="/resolutionList/statusFilter" method="post" class="shadow-lg mb-5 bg-white rounded p-3 d-flex flex-column">
    ...
    <table class="table mt-5 " id="tableId">
        ...
        <#list resolutions?ifExists as resolution>
            <tr>
                ...
                <td><div class="rounded mt-2 shadow-lg mb-2 rounded my_table_row" ><a href="/resolution/${resolution?ifExists.id?ifExists}">Перегляд</a></div></td>
            </tr>
        </#list>
        </tbody>
    </table>
